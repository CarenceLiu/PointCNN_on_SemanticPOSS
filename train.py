...
parser.add_argument('--num_point', type=int, default=65536, help='Point number [default: 65536]')
parser.add_argument('--max_epoch', type=int, default=2000, help='Epoch to run [default: 2000]')
